...
2.  Métodos de Penalidades
    ...
    2.  Método do Lagrangeano Aumentado (ref [Martínez, J. M. Otimização prática usando o Lagrangeano aumentado](http://www.ime.unicamp.br/~martinez/lagraum.pdf))
        1.  Apresentação do pacote computacional [Algencan](https://www.ime.usp.br/~egbirgin/tango/codes.php#algencan)
    3.  Penalidade interna / barreiras / Pontos interiores
...
4.  Dualidade
    ...
    2.  Dualidade Fraca. Dualidade Forte em problemas convexos
    3.  Casos de interesse (problemas lineares e quadráticos)
5.  O Problema de Quadrados Mínimos Linear e Não-Linear
